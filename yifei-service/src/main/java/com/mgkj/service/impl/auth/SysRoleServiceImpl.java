...
import com.mgkj.mapper.auth.SysRoleMapper;
import com.mgkj.service.auth.SysRoleService;
...
//        }
    ...
    public void doAssign(AssginRoleVo assginRoleVo) {
        ...
        LambdaQueryWrapper<SysUserRole> wrapper = new LambdaQueryWrapper<>();
        wrapper.eq(SysUserRole::getUserId,assginRoleVo.getUserNo());
        ...
        for(Long roleId : roleIdList) {
            ...
            sysUserRole.setUserId(assginRoleVo.getUserNo());
