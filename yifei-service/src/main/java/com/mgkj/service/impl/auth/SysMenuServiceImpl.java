...
import com.mgkj.mapper.auth.SysMenuMapper;
...
import com.mgkj.service.impl.auth.utils.MenuHelper;
import com.mgkj.vo.auth.AssginMenuVo;
import com.mgkj.vo.auth.MetaVo;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    @Override
    public List<SysMenu> findMenuByRoleIdList(List<Long> roleIdList) {
        ...
        //2 根据角色id roleId查询 角色菜单关系表里面 角色id对应所有的菜单id
        List<SysRoleMenu> sysRoleMenuList = sysRoleMenuMapper.selectListByRoleIdList(roleIdList);
        ...
        //4 返回规定树形显示格式菜单列表
        List<SysMenu> sysMenuList = MenuHelper.buildTreeByIsSelect(allSysMenuList,475L);
