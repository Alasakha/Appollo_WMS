...
@ToString
@EnableSwagger2
@ApiModel(value = "PO_QC_RESULT_SD实体类，用于映射PO_QC_RESULT_SD表数据")
@TableName("PO_QC_RESULT_SD")
public class POQCRESULTSD {

    /**
     * 主键
     */
    @TableId(value = "PO_QC_RESULT_SD_ID")
    private String PO_QC_RESULT_SD_ID;
     ...
     *
     */
    @TableField(value = "PO_QC_RESULT_D_ID")
