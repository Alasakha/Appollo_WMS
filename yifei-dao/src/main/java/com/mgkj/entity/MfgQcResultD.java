...
/**
 * 维护工单质检业务单身/CHT/維護工單質檢業務單身
 * @TableName MFG_QC_RESULT_D
 */
@TableName(value ="MFG_QC_RESULT_D")
@Data
public class MfgQcResultD implements Serializable {
    /**
     * 主键
     */
    @TableId(value = "MFG_QC_RESULT_D_ID")
     ...
     * 待判定量
     */
    @TableField(value = "TO_DECIDE_QTY")
    private BigDecimal TO_DECIDE_QTY;
     ...
     * 
     */
    @TableField(value = "MFG_QC_RESULT_ID")
