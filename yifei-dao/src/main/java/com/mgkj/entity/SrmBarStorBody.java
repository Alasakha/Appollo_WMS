 ...
 * @TableName srm_bar_stor_body
 */
@Data
public class SrmBarStorBody {
    /**
     * 仓库编号
     ...
     * 产生ERP库位异动
     */
    private String erpStorChg;

    /**
     * 物料单一批次存放

     */
    private String stuffStorAlon;

    /**
     * 对应ERP储位
     */
    private String erpToStor;

    /**
     * 不良储位
     */
    private String badStorage;
